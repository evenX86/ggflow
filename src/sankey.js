d3.sankey = function () {
    ...
    sankey.link = function () {
        ...
        function link(d) {
            var x0 = d.source.x + d.source.dx,
                ...
                yi = d3.interpolateNumber(y0, y1),//传进闭包,计算link的坐标值
                y3 = yi(temp),
    ...
    /**update xyf 2013-10-21:没有outgoing不能设成最大breadth*/
    function computeNodeBreadths() {
        ...
        /*6本来是上面的x值但是为了使固定列之间的宽度就设定了一个固定值*/
        scaleNodeBreadths((4300 - nodeWidth) / (6 + 7.5));
        /*设置不同列之间的node的距离*/
    }
